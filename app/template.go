...
<head>
	...
	%v
    <link rel="stylesheet" href="/static/ui-node.css">
	<link rel="stylesheet" href="/static/ui-date.css">
</head>
<body>
	<header>
		<!-- 返回概览标签 -->
    ...
    <div class="container">
		...
		<!-- 可拖动日期的悬浮按钮 -->
		<div id="buttonContainer" style="position: fixed; z-index: 1000;">
			<button id="draggableButton" class="draggable-button">日期</button>
			<!-- 日期选择器 -->
